        ...
        children: <Widget>[
          Container(
            ...
            child: IconButton(
              ...
              color: Colors.black,
              onPressed: () {
                Navigator.pop(context, ['edit', item['repetition'], item['id'], item['recording_date']]);
              },
            ),
          ),
          SizedBox(width: 15),
          Container(
            ...
            child: IconButton(
              ...
              color: Colors.red,
              onPressed: () {
                _deleteBenchHistory(item['id'].toString(), item['benchmark_id'].toString());
              },
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Container(
            width: width/3,
            child: Text('${item['recording_date_format']}',
