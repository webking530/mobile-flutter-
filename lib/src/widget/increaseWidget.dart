...
class _increaseWidget extends State<IncreaseWidget> with SingleTickerProviderStateMixin{
  Timer timer;
  String timeText = '';
  double fontVal = 0;
  ...
  void updateClock() {
    ...
    if(statusFlag == 'Start'){
      millisecondsRemaining = (duration.inMilliseconds + 1000) - stopwatch.elapsed.inMilliseconds;
    }else if(statusFlag == 'Restart'){
      millisecondsRemaining = (duration.inMilliseconds + 1000) - stopwatch.elapsed.inMilliseconds;
    }else{
